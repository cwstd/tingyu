    ...
    public static void main(String[] args) {
        ...
        //策略配置
            ...
            stConfig.setCapitalMode(true) //全局大写命名
                    ...
                    .setTablePrefix("t_")
                    .setInclude("t_admin","t_admin_role","t_company","t_host","t_host_power","t_married_person","t_menu","t_order","t_planner","t_role","t_role_menu"); // 生成的表，多个表继续传递即可，String类型的可变参数
        //将策略配置对象集成到代码生成器中
